...
class ArrayOfSellratingreasonsumstruct implements \ArrayAccess, \Iterator, \Countable
{
     ...
     * @param SellRatingReasonSumStruct $value The value to set
     * @return void
     */
     ...
     *
     * @return SellRatingReasonSumStruct Return the current element
     */
     ...
     *
     * @return SellRatingReasonSumStruct Return count of elements
     */
