...
class ArrayOfSellratingaveragepermonthstruct implements \ArrayAccess, \Iterator, \Countable
{
     ...
     * @param SellRatingAveragePerMonthStruct $value The value to set
     * @return void
     */
     ...
     *
     * @return SellRatingAveragePerMonthStruct Return the current element
     */
     ...
     *
     * @return SellRatingAveragePerMonthStruct Return count of elements
     */
