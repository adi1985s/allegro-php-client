...
class ArrayOfMyfeedbackliststruct2 implements \ArrayAccess, \Iterator, \Countable
{
     ...
     * @param MyFeedbackListStruct2 $value The value to set
     * @return void
     */
     ...
     *
     * @return MyFeedbackListStruct2 Return the current element
     */
     ...
     *
     * @return MyFeedbackListStruct2 Return count of elements
     */
